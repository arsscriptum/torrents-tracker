...
log_info "Start the torrents-tracker service"
sudo systemctl start torrents-tracker.service

log_info "Check if the service started successfully"
if systemctl is-active --quiet torrents-tracker.service; then
    log_info "torrents-tracker.service started successfully."
else
    log_warning "Failed to start torrents-tracker.service."
fi
